...
final class WebCrawlerTest {
  @Inject
  private WebCrawler crawler;

  private static final String DATA_DIR = System.getProperty("testDataDir");//"C:\\Git\\cd0381-advanced-java-programming-techniques-projectstarter-master\\starter\\webcrawler\\src\\test\\data";//

  static Stream<Class<?>> provideTestParameters() throws Exception {
    String[] names = System.getProperty("crawlerImplementations").split("\\s+");//new String[]{"com.udacity.webcrawler.ParallelWebCrawler"};//
  ...
  @Test
  void testSequentialParallelism() {
    CrawlerConfiguration config =
        new CrawlerConfiguration.Builder()
            .setParallelism(1)
            .build();
  ...
  void zeroMaxDepth(Class<?> crawlerClass) {
    CrawlerConfiguration config =
        new CrawlerConfiguration.Builder()
  ...
  @ParameterizedTest
  @MethodSource("provideTestParameters")
  void noStartPages(Class<?> crawlerClass) {
    CrawlerConfiguration config =
        new CrawlerConfiguration.Builder()
            .setImplementationOverride(crawlerClass.getName())
            .setMaxDepth(10)
  ...
  @ParameterizedTest
  @MethodSource("provideTestParameters")
  void testBasicCrawl(Class<?> crawlerClass) {
    CrawlerConfiguration config =
        new CrawlerConfiguration.Builder()
            .setImplementationOverride(crawlerClass.getName())
            .setMaxDepth(10)
  ...
  @ParameterizedTest
  @MethodSource("provideTestParameters")
  void respectsIgnoredUrls(Class<?> crawlerClass) {
    CrawlerConfiguration config =
        new CrawlerConfiguration.Builder()
            .setImplementationOverride(crawlerClass.getName())
            .setMaxDepth(10)
  ...
  @ParameterizedTest
  @MethodSource("provideTestParameters")
  void respectsIgnoredWords(Class<?> crawlerClass) {
    CrawlerConfiguration config =
        new CrawlerConfiguration.Builder()
            .setImplementationOverride(crawlerClass.getName())
            .setMaxDepth(10)
  ...
  @ParameterizedTest
  @MethodSource("provideTestParameters")
  void respectsMaxDepth(Class<?> crawlerClass) {
    CrawlerConfiguration config =
        new CrawlerConfiguration.Builder()
            .setImplementationOverride(crawlerClass.getName())
            .setMaxDepth(1)
  ...
  @ParameterizedTest
  @MethodSource("provideTestParameters")
  void pageNotFoundStillCountsAsVisited(Class<?> crawlerClass) {
    CrawlerConfiguration config =
        new CrawlerConfiguration.Builder()
            .setImplementationOverride(crawlerClass.getName())
            .setMaxDepth(10)
  ...
  @ParameterizedTest
  @MethodSource("provideTestParameters")
  void infiniteLoop(Class<?> crawlerClass) {
    CrawlerConfiguration config =
        new CrawlerConfiguration.Builder()
            .setImplementationOverride(crawlerClass.getName())
            .setMaxDepth(10)
  ...
  @ParameterizedTest
  @MethodSource("provideTestParameters")
  void multipleStartingUrls(Class<?> crawlerClass) {
    CrawlerConfiguration config =
        new CrawlerConfiguration.Builder()
            .setImplementationOverride(crawlerClass.getName())
            .setMaxDepth(10)
