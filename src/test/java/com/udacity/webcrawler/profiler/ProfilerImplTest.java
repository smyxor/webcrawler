...
final class ProfilerImplTest {
  ...
  @Test
  void delegateHasNoMethodsAnnotated() {
    assertThrows(
  ...
  @Test
  void testBasicProfiling() throws Exception {
    ProfiledInterface proxy = profiler.wrap(ProfiledInterface.class, delegate);
  ...
  @Test
  void testDeclaredExceptionHandling() throws Exception {
    ProfiledInterface proxy = profiler.wrap(ProfiledInterface.class, delegate);
